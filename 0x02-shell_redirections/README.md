...
0x02. Shell, I/O Redirections and filters
 By Julien Barbier
 Weight: 1
 Ongoing project - started 01-31-2022, must end by 02-01-2022 (in about 14 hours) - you're done with 0% of tasks.
 Checker was released at 01-31-2022 06:00 AM
...
0. Hello World
mandatory
Write a script that prints âHello, Worldâ, followed by a new line to the standard output.
...
Tips: âThinks of it as a cat, what is at the end of it?â
...
adopted in Italian (Il dado Ã¨ tratto), Romanian (Zarurile au fost aruncate),
Spanish (La suerte estÃ¡ echada), French (Les dÃ©s sont jetÃ©s), Portuguese (A
sorte estÃ¡ lanÃ§ada), Dutch (De teerling is geworpen),
...
mandatory
Display lines containing the pattern ârootâ from the file /etc/passwd
...
15. Count that word
mandatory
Display the number of lines that contain the pattern âbinâ in the file /etc/passwd
...
16. What's next?
mandatory
Display lines containing the pattern ârootâ and 3 lines after them in the file /etc/passwd.
...
17. I hate bins
mandatory
Display all the lines in the file /etc/passwd that do not contain the pattern âbinâ.
